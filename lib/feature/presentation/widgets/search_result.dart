...
class SearchResult extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => PersonDetailPage(personEntity: personResult)));
      },
      child: Card(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 300, width: double.infinity, child: PersonCacheImage(
